...
(function($){
	...
	$.fn.bxSlider = function(options){		
		...
		var defaults = {
			...
			nextSelector: '#home-photo-next', 								// jQuery selector - element to contain the next control. ex: '#next'
			prevText: '',										// string - text displayed for 'previous' control
			prevImage: '',											// string - filepath of image used for 'previous' control. ex: 'images/prev.jpg'
			prevSelector: '#home-photo-prev', 								// jQuery selector - element to contain the previous control. ex: '#next'
