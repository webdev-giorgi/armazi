...
$cms_config = '../../../_manager/config.php';
if (file_exists($cms_config))
...
$base_url =
 ...
 '://'.
 // Get domain portion
$_SERVER['HTTP_HOST']; // tora DON'T TOUCH (base url (only domain) of site (without final /)).
...
$thumbs_base_path = '../../../files/.tmb/'; // relative path from filemanager folder to thumbs folder (with final /)
