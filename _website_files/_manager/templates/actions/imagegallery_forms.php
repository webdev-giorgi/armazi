...
<?php $ulink = ($route[1]=="add") ? ahref(array($route[0], 'add', $menuid)) : ahref(array($route[0], 'edit', $id)); ?>
                <form id="catform" name="catform" method="post" action="<?php echo $ulink;?>">
                    ...
                    <input type="hidden" name="menuid" value="<?php echo $menuid ?>" />
                        ...
                        <div class="list2 fix">
                            <div class="name">Description: <span class="star">*</span></div>
                            <input type="text" id="description" name="description" value="<?php echo ($route[1]=='edit') ? $description : '' ?>" class="inp"/>
                        </div>                    

                        <div class="list2 fix">
                            <div class="name"><?php echo a("itemlink");?>: <span class="star">*</span></div>
                            <input type="text" id="link" name="link" value="<?php echo ($route[1]=='edit') ? $link : '' ?>" class="inp" style="width:500px;"/>
                        </div>
                        ...
                        <div class="list2 fix">
                            ...
                            <input type="checkbox" name="homepage" class="inp-check"<?php echo (($route[1]=='edit')&&($homepage==0)) ? '' : ' checked' ?> />
                        </div>
