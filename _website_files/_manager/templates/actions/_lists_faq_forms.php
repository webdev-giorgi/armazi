        ...
        <div id="part">
            ...
            <div id="t1">
                <div id="news">
					...
					<input type="hidden" name="meta_keys" value="" />
...
<?php endif; ?>
                    ...
                    <div class="list fix">
                        <div class="name"><?php echo a("question");?>: <span class="star" title="">*</span></div>					
                    ...
                    <div class="list2 fix">
                        ...
                        <input type="text" name="postdate" value="<?php echo ($route[1]=='edit') ? date('Y-m-d', strtotime($edit["postdate"])) : date('Y-m-d'); ?>" id="postdate" class="inp-small" />
<script language="JavaScript">
	new tcal ({
		...
		'controlname': 'postdate',
                            ...
                            <input type="text" name="pagetime" value="<?php echo ($route[1]=='edit') ? date('H:i:s', strtotime($edit["postdate"])) : date('H:i:s'); ?>" id="posttime" class="inp-small" />
                    </div>	

                    <div class="list fix">
                        <div class="name"><?php echo a("expiredate");?>: <span class="star" title="<?php echo a('tt.bannerexpiredate');?>">*</span></div>					
                        <input type="text" name="expiredate" value="<?php echo ($route[1]=='edit') ? date('Y-m-d', strtotime($edit["expiredate"])) : date('Y-m-d'); ?>" id="expiredate" class="inp-small" />
<script language="JavaScript">
	new tcal ({
		'formname': 'dataform',
		'controlname': 'expiredate',
                            ...
                            <input type="text" name="expiretime" value="<?php echo ($route[1]=='edit') ? date('H:i:s', strtotime($edit["expiredate"])) : date('H:i:s'); ?>" id="posttime" class="inp-small" />
                    </div>	
                    ...
                    <div class="list2 fix">
                        <div class="name"><?php echo a("answer");?>: <span class="star" title="">*</span></div>		
                        <textarea id="text_content" name="content" style="width:800px; height:300px; margin-top:2px; margin-bottom:2px;"><?php echo ($route[1]=='edit') ? $edit["content"] : '' ?></textarea>
                    </div>	
                </div>
            </div>
			</form>
